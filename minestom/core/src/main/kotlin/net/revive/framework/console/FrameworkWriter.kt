...
import net.revive.framework.MinestomFrameworkServer
...
class FrameworkWriter(_properties: Map<String?, String>) : Writer {
    ...
    override fun close() {
        MinestomFrameworkServer.terminalThread.interrupt()
        println()
    }
}