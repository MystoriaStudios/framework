...
abstract class AbstractPagedMenu : IMenu {
     ...
     */
    open fun getPrePaginatedTitle(player: FrameworkPlayer): Component? = null
     ...
     */
    open fun getUnPaginatedTitle(player: FrameworkPlayer): Component {
     ...
     */
    fun modPage(player: FrameworkPlayer, mod: Int) {
        page += mod
     ...
     */
    fun getPages(player: FrameworkPlayer): Int {
     ...
     */
    open fun getGlobalButtons(player: FrameworkPlayer): Map<Int, IButton>? = null
     ...
     */
    abstract fun getAllPagesButtons(player: FrameworkPlayer): Map<Int, IButton>
