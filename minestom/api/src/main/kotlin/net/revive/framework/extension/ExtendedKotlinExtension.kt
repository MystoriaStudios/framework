package net.revive.framework.extension
...
open class ExtendedKotlinExtension : Extension(), IConfigProvider {

    override fun getBaseFolder() = ExtensionBootstrap.getExtensionManager().extensionFolder
    ...
    var logger: Logger = Logger.getLogger("Framework Extensions")
