...
) : FrameworkStorageLayer<AbstractFrameworkRedisConnection, D, (D) -> Boolean>(connection)
{
        ...
        runSafely {
            connection.useResource {
                sync().hset(
                    ...
                    Framework.instance.serializer.serialize(data)
                )
            }
        }
    }
    ...
    override fun loadSync(identifier: UUID): D?
    {
        return runSafelyReturn {
            ...
            return@runSafelyReturn Framework.instance.serializer.deserialize(dataType, serialized)
        }
    }
    ...
    override fun loadAllSync(): Map<UUID, D>
    {
        return runSafelyReturn {
            ...
            {
                deserialized[UUID.fromString(mutableEntry.key)] = Framework.instance.serializer.deserialize(dataType, mutableEntry.value)
            }
