...
class EditItemStackMenu(private var reference: ItemStack = ItemStack.empty()) : IMenu {
    ...
    override fun getButtons(player: FrameworkPlayer): Map<Int, IButton> {
        return mapOf(
            0 to object : IButton {
                override fun getMaterial(player: FrameworkPlayer) = XMaterial.matchXMaterial(reference.type)
            ...
            1 to object : AbstractInputButton() {
                ...
                override fun getMaterial(player: FrameworkPlayer): XMaterial = XMaterial.OAK_SIGN
